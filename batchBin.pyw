'''
Read PLC tag data every 5 seconds and make respective API calls when conditions are met
'''
import json
import time
import requests
...
def getBatchID():
    '''
    Make GET API call to localhost and store batch and lane IDs in variables
    '''
    global _batchID
